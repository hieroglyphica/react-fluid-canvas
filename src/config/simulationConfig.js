...
export const config = {
  ...
  DENSITY_DISSIPATION: 0.99,    // Dye fade rate (0..1)
  VELOCITY_DISSIPATION: 0.99,   // Velocity decay (0..1)
  PRESSURE_ITERATIONS: 30,      // Jacobi iterations — typical: 8..48
  CURL: 1,                     // Vorticity strength (0..50)
  SPLAT_RADIUS: 0.005,           // Splat radius (normalized, ~0.001..0.03)
  SPLAT_FORCE: 3500,            // Splat force multiplier (1000..10000)
  SHADING: true,               // Pseudo-3D shading (bool)
  ...
  BRIGHTNESS: 1.7,              // Global brightness multiplier (0.5..2.5)
